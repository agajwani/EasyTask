<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MasterForgetPassword.aspx.cs" Inherits="test1.ForgetPassword" %>
...
&nbsp;<asp:TextBox ID="fgtpass" runat="server" CssClass="text"></asp:TextBox>
        ...
        <br />
        <br />
        <asp:Button ID="fgbshow" CssClass="button" runat="server" Text="Show" OnClick="fgbshow_Click" />
